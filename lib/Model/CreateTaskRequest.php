...
class CreateTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets feed_type
     *
     * @param string|null $feed_type The feed type associated with the task. The only presently supported value is LMS_ORDER_ACK.
     *
     * @return self
     */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The schemaVersion version number of the file format. Acceptable value: 1.0
     *
     * @return self
     */
